    ...
    return (
        ...
        >
            <section className="grid place-items-center w-full relative mt-[10vh]">
                <div ref={textRef} className="text font-alt uppercase flex content-center text-[clamp(2.5rem,10vw,7rem)] leading-[0.7] text-neutral-900 dark:text-white">
                    {splitText(centerText)}
                </div>
            </section>

            <section className="grid place-items-center w-full relative">
                <div ref={gridFullRef} className="grid--full relative w-full my-[5vh] h-auto aspect-[1.5] max-w-7xl p-4 grid gap-4 grid-cols-7 grid-rows-5">
                    ...
                    {mixedGridItems.map((item, i) => {
                        if (item === 'BENTO_GROUP') {
                            ...
                            return (
                                <div key="bento-group" data-col={3} className="grid__item bento-container col-span-3 row-span-2 relative z-20 flex items-center justify-center gap-2 h-full w-full will-change-transform">
                        ...
                        if (i === 11 || i === 12 || i === 17 || i === 18) return null;
