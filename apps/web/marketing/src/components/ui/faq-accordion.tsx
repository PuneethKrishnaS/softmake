...
export function FaqAccordion({
  ...
  return (
    <div className={cn("w-full max-w-3xl mx-auto py-8 relative font-sans", className)} {...props}>
      {title && (
        <h2 className="text-center font-bold text-2xl md:text-3xl mb-10 text-neutral-800 dark:text-neutral-200">
          {title}
        </h2>
      )}
            ...
            >
              <button
                className={cn(
                  ...
                  isActive 
                    ? "border-l-blue-600 dark:border-l-blue-400 bg-blue-50/20 dark:bg-neutral-800/30 text-neutral-900 dark:text-neutral-100 font-semibold" 
              ...
              >
                <span 
                  className={cn(
                    ...
                    isActive ? "text-[32px] md:text-[40px] font-normal text-blue-600 dark:text-blue-400" : "text-[24px] md:text-[30px] font-normal text-neutral-400 dark:text-neutral-500"
                  )}
                >
                  {isActive ? "-" : "+"}
                </span>
                ...
                <span 
                  className={cn(
                    ...
                    isActive ? "rotate-[-44deg] border-blue-600 dark:border-blue-400" : "rotate-[133deg] border-neutral-400 dark:border-neutral-500"
                  )}
                />
              </button>
              ...
              <div 
                className={cn(
                  ...
                  isActive ? "grid-rows-[1fr] border-l-blue-600 dark:border-l-blue-400 bg-blue-50/20 dark:bg-neutral-800/30" : "grid-rows-[0fr] border-l-neutral-300 dark:border-l-neutral-700 bg-transparent"
                )}
              >
                <div className="overflow-hidden">
                  <div className="flex flex-row items-start justify-start w-full px-4 pl-14 pb-6 pt-2 text-base md:text-lg font-normal text-neutral-700 dark:text-neutral-300">
                    <span className="opacity-90 leading-relaxed">{item.answer}</span>
                  </div>
                </div>
              </div>
            </li>
