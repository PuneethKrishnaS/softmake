...
import macbookImage from '../../assets/screens/Apple Macbook Pro Laptop.png';
...
export default function LaptopMockup() {
  ...
  return (
    <div className="relative w-full aspect-[1.6]">
      <div 
        ref={containerRef}
        className="absolute z-10 overflow-hidden bg-black text-left"
        style={{ top: '12%', bottom: '13%', left: '12.5%', right: '12.5%' }}
      >
        <div 
          className="bg-background flex w-full h-full"
          style={{
            width: `${BASE_WIDTH}px`,
        ...
        >
          {/* Sidebar */}
          <div className="w-[20%] bg-sidebar text-sidebar-foreground flex flex-col text-[8px] md:text-xs border-r border-sidebar-border h-full">
          ...
          {/* Main Content */}
          <div className="flex-1 flex flex-col p-3 md:p-4 overflow-hidden h-full">
            {/* Header */}
