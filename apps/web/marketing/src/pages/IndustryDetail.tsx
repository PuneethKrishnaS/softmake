...
export default function IndustryDetail() {
  ...
  const industry = slug ? industriesRegistry[slug] : undefined;
    ...
    return (
      <div className="max-w-[1440px] mx-auto py-24 text-center bg-background text-foreground flex flex-col items-center justify-center min-h-[60vh]">
        ...
        <p className="text-sm md:text-base text-muted-foreground mt-4 max-w-md leading-relaxed">
          The requested industry page does not exist or has been restructured. Explore our core industry vertical indices.
        </p>
        <Link
          to="/industries"
  ...
  const prefilledText = `Hi Softmake.in team, I'd like to inquire about your custom software solutions for the "${industry.title}". Specifically, we are looking to achieve:`;
  ...
  return (
    <div className="max-w-[1440px] mx-auto text-left bg-background text-foreground">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
        ...
        {/* Left Column: Industry Details & Tech Stack */}
        <div className="lg:col-span-7 flex flex-col gap-10">
          ...
          <div className="border-t border-border pt-8">
            <h3 className="text-lg md:text-xl font-bold font-sans mb-6">Vertical Software Solutions</h3>
            <div className="flex flex-col gap-6">
              {industry.solutions.map((sol, i) => (
                <div key={i} className="flex items-start gap-4 p-4 rounded-lg bg-muted/10 border border-border/40">
                  <div className="w-1.5 h-1.5 rounded-full bg-primary mt-2 shrink-0" />
                  <div>
                    <h4 className="text-sm md:text-base font-bold font-sans">{sol.title}</h4>
                    <p className="text-xs md:text-sm text-muted-foreground mt-1 leading-relaxed">{sol.text}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          {/* Benefits Outcomes */}
          <div className="border-t border-border pt-8">
            <h3 className="text-lg md:text-xl font-bold font-sans mb-4">Target Outcomes & Metrics</h3>
          ...
          {/* Deployment Stack */}
          <div className="border-t border-border pt-8">
            <h3 className="text-lg md:text-xl font-bold font-sans mb-3">Technology Frameworks</h3>
        ...
        <div className="lg:col-span-5 lg:sticky lg:top-24">
          <div className="mb-6">
            <h3 className="text-lg md:text-xl font-bold font-sans">Request Industry Software Consultation</h3>
            <p className="text-xs md:text-sm text-muted-foreground mt-1.5 leading-relaxed">
              Submit your project targets below to connect directly with a vertical software engineering expert.
            </p>
          </div>
